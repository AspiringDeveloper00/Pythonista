...
INSERT INTO `chapters_users_info` VALUES (3,'AdvancedTest'),(3,'BasicsTest'),(3,'Chapter1'),(3,'Chapter2'),(3,'Chapter3'),(3,'Chapter4'),(3,'Chapter5'),(3,'Chapter6'),(3,'Quickstart');
...
INSERT INTO `level_test` VALUES ('AdvancedTest_test','mul','Loop through the items in the fruits list, fruits = [\"apple\", \"banana\", \"cherry\"].Choose the right answer:\r','for x in fruits:','for x on fruits:','for x in fruits:','for x: for fruits:','','Chapter5','For loops'),('BasicsTest_test','gap','Print \"Hello\" if a is equal to b, or c is equal to d. Fill the gap. if a == b ___ c == d: print(\"Hello\")','or','','','','','Chapter2','Strings'),('BasicsTest_test','gap','Split the string txt=\"Hello, Word\" with the right method.','txt.split(,)','','','','','Chapter2','Strings'),('AdvancedTest_test','gap','Use a range of indexes to print the third, fourth, and fifth item in the list.\r\nfruits = [\"apple\", \"banana\", \"cherry\", \"orange\", \"kiwi\", \"melon\", \"mango\"]\r\nprint(fruits[___])','2:5','','','','','Chapter4','Lists'),('ExpertTest_test','gap','Use the p1 object to print the value of x:\r\nclass MyClass:\r\n  x = 5\r\n\r\np1 = MyClass()\r\nprint(___)','p1.x','','','','','Chapter8','Classes'),('AdvancedTest_test','gap','Use the range function to loop through a code set 6 times.Fill the gap \r for x in ____:\r    print(x)\r','range(6)','','','','','Chapter5','For loops'),('BasicsTest_test','mul','What characters are illegal in the variable name 4my-first_name ?','4 and -','4 and -','- and _','4 and _','','Chapter1','Variables'),('ExpertTest_test','mul','What is the correct syntax to assign a \"init\" function to a class?','__init__','__init__','_init_','__init','','Chapter8','Classes'),('ExpertTest_test','gap','What is the correct syntax to execute the printname method of the object x?\r\nclass Person:\r\n  def __init__(self, fname):\r\n    self.firstname = fname\r\n  def printname(self):\r\n    print(self.firstname)\r\nclass Student(Person):\r\n  pass\r\n\r\nx = Student(\"Mike\")\r\n______________\r\n','x.printname()','','','','','Chapter9','Inheritance'),('BasicsTest_test','gap','What misses so this can be a correct syntax? age = 36 txt = \"My name is John, and I am ___\" print(txt.format(age))','{}','','','','','Chapter2','Strings');
...
INSERT INTO `levels` VALUES (3,'finished');
...
INSERT INTO `tests_users_info` VALUES (3,'AdvancedTest_test',100),(3,'BasicsTest_test',100),(3,'Chapter1_test',100),(3,'Chapter2_test',100),(3,'Chapter3_test',100),(3,'Chapter4_test',100),(3,'Chapter5_test',100),(3,'Chapter6_test',100),(3,'Quickstart_test',100);
...
-- Dump completed on 2022-06-12 21:30:03
